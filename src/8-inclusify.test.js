...
describe("inclusify", () => {
  ...
  test("celles/ ceux are properly replaced", () => {
    expect(inclusify("Celles qui vont mourir te saluent")).toBe(
      "Celleux qui vont mourir te saluent",
    );
    expect(inclusify("Ceux qui vont mourir te saluent")).toBe(
      "Celleux qui vont mourir te saluent",
    );
  });
});
